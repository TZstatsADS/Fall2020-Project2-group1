...
Res_cleaned <- Res_cleaned %>% select("Restaurant.Name", "Business.Address","GRADE", "Postcode", "Latitude", "Longitude", "CUISINE.DESCRIPTION", "categories", "Approved.for.Sidewalk.Seating", "Approved.for.Roadway.Seating", "Qualify.Alcohol")
...
Restaurant[Restaurant$Postcode == 10025 & Restaurant$GRADE %in% c("B", "C") & Restaurant$categories %in% c("European", "Fast_food", "Americas") & Restaurant$Qualify.Alcohol %in% "no" & Restaurant$Approved.for.Roadway.Seating %in% "yes" & Restaurant$Approved.for.Sidewalk.Seating == "yes", ]
