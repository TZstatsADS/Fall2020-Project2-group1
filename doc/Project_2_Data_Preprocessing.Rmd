...
Res_cleaned <- Res_cleaned %>% select("Restaurant.Name", "Business.Address","GRADE", "Postcode", "Latitude", "Longitude", "CUISINE.DESCRIPTION", "categories")

write.csv(Res_cleaned, file="../data/Restaurant_cleaned.csv", row.names = FALSE)
